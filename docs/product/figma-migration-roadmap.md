...
- Add inspector controls for layout mode, flow, alignment, distribution, gap, padding, and constraints.
- Add Playwright coverage for automatic sibling repositioning and parent resize behavior.

Non-goals for the first slice:

- Grid auto layout.
- Wrap, margins, absolute/static layout item controls, min/max, baseline alignment, and advanced sizing rules.
