...
| `2026-06-16-deployment-automation.md` | Completed, historical | Merged in PR #8, `3d824bc`, with static web deployment docs, relay Docker artifacts, and artifact tests. The GitHub Pages workflow was later removed from active CI and restored on 2026-06-22 for static web deployment only. |
