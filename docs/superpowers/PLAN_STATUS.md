...
| --- | --- | --- |
| _None_ | Idle | No active plan. Latest completed Penpot maturity-loop slice is `2026-07-05-penpot-svg-raw-image-import.md`; deployment remains intentionally deferred. |
