...
5. Full import/export workflow beyond the landed single-file, project-level,
   ...
   backup/restore runbooks, hosted multi-instance registry sync with durable auth, hosted durable
   pub/sub fanout beyond shared-filesystem registry events, and Penpot/Figma migration paths where feasible.
