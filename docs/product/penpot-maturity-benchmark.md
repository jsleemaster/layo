...
5. Full import/export workflow beyond the landed single-file, project-level,
   ...
   no-write Penpot/Figma migration preflight:
   ...
   actual Penpot/Figma geometry/style/asset import mapping where feasible.
