...
1. Complete Penpot-like layout maturity beyond the landed Flex alignment, child-margin, static/absolute layout-item, wrap, and row/column gap slices: grid-like layout behavior, fit/fill sizing, min/max rules, baseline alignment, and deeper resizing semantics.
