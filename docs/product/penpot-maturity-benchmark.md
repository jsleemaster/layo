...
5. Full import/export workflow beyond the landed single-file, project-level,
   ...
   registry token-bundle review/import replacement path:
   backup/restore runbooks, hosted permissioned registry sync, cross-process
   registry update fanout, and Penpot/Figma migration paths where feasible.
