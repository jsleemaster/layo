...
5. Full import/export workflow beyond the landed single-file, project-level,
   ...
   no-write Penpot/Figma migration preflight and first Figma REST JSON basic
   import path:
   ...
   deeper Penpot/Figma geometry/style/asset import mapping where feasible.
