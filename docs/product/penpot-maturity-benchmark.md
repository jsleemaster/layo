...
| Collaboration | Realtime collaboration as a core team feature. | Yjs relay, presence, remote selection, roles, E2EE snapshots, manual saved file versions with HTTP/MCP/UI restore, and thresholded automatic file versions for persisted edits. Comments, visual diff, pinned/version preview controls, and review workflows remain immature. | Collaboration treated as core product maturity, including comments, history, review, and recovery. |
...
2. Comments, visual diff, branch/review/merge, pinned/version preview controls, retention controls, and richer recovery workflow beyond the landed manual/automatic saved file versions and restore path.
