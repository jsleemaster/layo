...
1. Complete Penpot-like layout maturity beyond the landed Flex alignment, child-margin, child fill sizing, equal-cell grid auto-placement, static/absolute layout-item, wrap, row/column gap, and container fit sizing slices: manual grid placement/areas/track units, min/max rules, baseline alignment, and deeper resizing semantics.
