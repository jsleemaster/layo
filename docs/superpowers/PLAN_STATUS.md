...
| --- | --- | --- |
| `2026-07-05-penpot-mask-clipping-import.md` | Active | PR #241 adapts Penpot masked-group imports from unclipped group containers to bounds-clipped group metadata plus code/SVG handoff. RED Full Verification #28730602500 failed before `RendererNode` supported `clip`; repair Full Verification #28730992728 passed gates/typecheck/build but failed Core tests on the old warning expectation and over-broad agent inspection assertion. Final acceptance is pending a green Full Verification on the documentation head; deployment remains intentionally deferred. |
