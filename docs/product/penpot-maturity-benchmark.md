...
| Import/export | Penpot file import/export, backups, shared libraries, assets. | Local design JSON, asset storage, image paste/drop, code export, document-local DTCG color/spacing token import/export, and a Layo-specific standard ZIP file archive with `manifest.json`, `document.json`, and packaged referenced image assets through storage, HTTP, and MCP. Visible web controls, import review, multi-file project archives, shared library packaging, and Penpot/Figma migration paths remain immature. | Open project export/import, Penpot/Figma migration paths, asset packaging, and backup/restore. |
...
5. Full import/export workflow beyond the landed Layo ZIP file archive:
   visible web import/export controls, import review before writing, multi-file
   project archives, shared library packaging, backup/restore runbooks, and
