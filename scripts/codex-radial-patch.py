...
replace_between(
    'function paintGradientForNode',
    '\n\nfunction svgGradientStopLine',
...
replace_between(
    'function svgGradientLinesForGradient',
    '\n\nfunction svgGradientLinesForTree',
...
replace_between(
    'function svgFillAttributeForNode',
    '\n\nfunction svgStrokeAttributeForNode',
...
replace_between(
    'function svgStrokeAttributeForNode',
    '\n\nfunction clipSourceOpacityForNode',
