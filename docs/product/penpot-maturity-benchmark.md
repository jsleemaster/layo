...
| Design systems | Tokens, components, variants, shared libraries. | Components, instances, first-class color tokens, node fill-token bindings, agent-editable token commands, Inspector token readouts, and CSS-variable code export exist; token sets/modes, typography/spacing tokens, reusable styles, variants, shared libraries, and code mappings remain immature. | First-class variables, styles, variants, library reuse, and code mapping. |
...
3. Design-system maturity beyond first-class color tokens and fill bindings: token sets/modes, W3C/DTCG import-export, typography/spacing tokens, reusable styles, variants, shared libraries, and code component mappings.
